...
CREATE TABLE PROYECTO_4_1 (
    ...
    DESCRIPCION_SUBPROYECTO VARCHAR2(30),
    FECHAFINAL_SUBPROYECTO DATE NULL,
    ...
    CONSTRAINT fk_proyecto_parteproyecto FOREIGN KEY (FECHAINICIO_SUBPROYECTO, DESCRIPCION_SUBPROYECTO) REFERENCES PROYECTO_4_1 (FECHAINICIO, DESCRIPCION)
);
